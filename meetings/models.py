...
#    participants = models.ForeignKey(MyUser, verbose_name='Participantes', on_delete=models.SET_NULL, null=True)
    date = models.DateField(verbose_name='Dia', default=date.today)
    time = models.TimeField(verbose_name='Hora do check-in', default=timezone.now)
